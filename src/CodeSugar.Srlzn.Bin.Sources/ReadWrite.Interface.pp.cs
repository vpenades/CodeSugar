...
using READABLEBLOCK = System.Collections.Generic.IEnumerator<byte>;
using WRITEABLEBLOCK = System.IProgress<byte>; 
...
#endif
{
    static partial class CodeSugarForSerialization
    {
        ...
        public static READABLEBLOCK ReadList<T>(this READABLEBLOCK source, ref List<T> result, ItemReadInterfaceDelegate<T> lambda)
        {
        ...
        public static READABLEBLOCK ReadList<T>(this READABLEBLOCK source, IList<T> result, ItemReadInterfaceDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
            if (count == 0) return source;            
        ...
        public static READABLEBLOCK ReadList<T>(this READABLEBLOCK source, out T[] result, ItemReadInterfaceDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
        ...
        public static WRITEABLEBLOCK WriteDictionary<T>(this WRITEABLEBLOCK target, IReadOnlyDictionary<string, T> source, ItemWriteInterfaceDelegate<T> lambda)
        {
            if (source == null) return target.WritePackedU64(0);
        ...
        public static READABLEBLOCK ReadDictionary<T>(this READABLEBLOCK source, ref Dictionary<string, T> result, ItemReadInterfaceDelegate<T> lambda)
        {
