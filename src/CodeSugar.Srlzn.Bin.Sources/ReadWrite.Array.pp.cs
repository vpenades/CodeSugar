...
#endif
{
    static partial class CodeSugarForSerialization
    {
        ...
        public delegate _WRITEABLEBLOCK ItemWriteArrayDelegate<T>([NotNull] _WRITEABLEBLOCK source, T item);
        public delegate _READABLEBLOCK ItemReadArrayDelegate<T>([NotNull] _READABLEBLOCK source, out T item);

        [return: NotNull]
        public static _WRITEABLEBLOCK WriteList<T>([NotNull] this _WRITEABLEBLOCK target, IReadOnlyList<T> source, ItemWriteArrayDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static _READABLEBLOCK ReadList<T>([NotNull] this _READABLEBLOCK source, ref List<T> result, ItemReadArrayDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static _READABLEBLOCK ReadList<T>([NotNull] this _READABLEBLOCK source, IList<T> result, ItemReadArrayDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
            if (count == 0) return source;            
        ...
        [return: NotNull]
        public static _READABLEBLOCK ReadList<T>([NotNull] this _READABLEBLOCK source, out T[] result, ItemReadArrayDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
        ...
        [return: NotNull]
        public static _WRITEABLEBLOCK WriteDictionary<T>([NotNull] this _WRITEABLEBLOCK target, IReadOnlyDictionary<string, T> source, ItemWriteArrayDelegate<T> lambda)
        {
            if (source == null) return target.WritePackedU64(0);
        ...
        [return: NotNull]
        public static _READABLEBLOCK ReadDictionary<T>([NotNull] this _READABLEBLOCK source, ref Dictionary<string, T> result, ItemReadArrayDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static _READABLEBLOCK ReadDictionary<T>([NotNull] this _READABLEBLOCK source, IDictionary<string, T> result, ItemReadArrayDelegate<T> lambda)        
        {
            result.Clear();
