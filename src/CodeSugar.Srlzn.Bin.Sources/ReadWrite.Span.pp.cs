...
using _READABLEBLOCK = System.ReadOnlySpan<byte>;
using _WRITEABLEBLOCK = System.Span<byte>;
...
#endif
{
    static partial class CodeSugarForSerialization
    {
        ...
        public delegate _WRITEABLEBLOCK ItemWriteSpanDelegate<T>(_WRITEABLEBLOCK source, T item);
        public delegate _READABLEBLOCK ItemReadSpanDelegate<T>(_READABLEBLOCK source, out T item);

        public static _WRITEABLEBLOCK WriteList<T>(this _WRITEABLEBLOCK target, IReadOnlyList<T> source, ItemWriteSpanDelegate<T> lambda)
        {
        ...
        public static _READABLEBLOCK ReadList<T>(this _READABLEBLOCK source, ref List<T> result, ItemReadSpanDelegate<T> lambda)
        {
        ...
        public static _READABLEBLOCK ReadList<T>(this _READABLEBLOCK source, IList<T> result, ItemReadSpanDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
            if (count == 0) return source;            
        ...
        public static _READABLEBLOCK ReadList<T>(this _READABLEBLOCK source, out T[] result, ItemReadSpanDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
        ...
        public static _WRITEABLEBLOCK WriteDictionary<T>(this _WRITEABLEBLOCK target, IReadOnlyDictionary<string, T> source, ItemWriteSpanDelegate<T> lambda)
        {
            if (source == null) return target.WritePackedU64(0);
        ...
        public static _READABLEBLOCK ReadDictionary<T>(this _READABLEBLOCK source, ref Dictionary<string, T> result, ItemReadSpanDelegate<T> lambda)
        {
            result ??= new Dictionary<string,T>();
            return ReadDictionary(source, result, lambda);
        }

        public static _READABLEBLOCK ReadDictionary<T>(this _READABLEBLOCK source, IDictionary<string, T> result, ItemReadSpanDelegate<T> lambda)        
        {
            result.Clear();
