...
#endif
{
    static partial class CodeSugarForSerialization
    {
        ...
        public delegate _WRITEABLEBLOCK ItemWriteSpanDelegate<T>([NotNull] _WRITEABLEBLOCK source, T item);
        public delegate _READABLEBLOCK ItemReadSpanDelegate<T>([NotNull] _READABLEBLOCK source, out T item);

        [return: NotNull]
        public static _WRITEABLEBLOCK WriteList<T>([NotNull] this _WRITEABLEBLOCK target, IReadOnlyList<T> source, ItemWriteSpanDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static _READABLEBLOCK ReadList<T>([NotNull] this _READABLEBLOCK source, ref List<T> result, ItemReadSpanDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static _READABLEBLOCK ReadList<T>([NotNull] this _READABLEBLOCK source, IList<T> result, ItemReadSpanDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
            if (count == 0) return source;            
        ...
        [return: NotNull]
        public static _READABLEBLOCK ReadList<T>([NotNull] this _READABLEBLOCK source, out T[] result, ItemReadSpanDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
        ...
        [return: NotNull]
        public static _WRITEABLEBLOCK WriteDictionary<T>([NotNull] this _WRITEABLEBLOCK target, IReadOnlyDictionary<string, T> source, ItemWriteSpanDelegate<T> lambda)
        {
            if (source == null) return target.WritePackedU64(0);
        ...
        [return: NotNull]
        public static _READABLEBLOCK ReadDictionary<T>([NotNull] this _READABLEBLOCK source, ref Dictionary<string, T> result, ItemReadSpanDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static _READABLEBLOCK ReadDictionary<T>([NotNull] this _READABLEBLOCK source, IDictionary<string, T> result, ItemReadSpanDelegate<T> lambda)        
        {
            result.Clear();
