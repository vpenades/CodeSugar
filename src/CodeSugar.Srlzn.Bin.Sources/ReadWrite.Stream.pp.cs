...
#endif
{
    static partial class CodeSugarForSerialization
    {
        ...
        public delegate _WRITEABLEBLOCK ItemWriteStreamDelegate<T>(_WRITEABLEBLOCK source, T item);
        public delegate _READABLEBLOCK ItemReadStreamDelegate<T>(_READABLEBLOCK source, out T item);

        public static _WRITEABLEBLOCK WriteList<T>(this _WRITEABLEBLOCK target, IReadOnlyList<T> source, ItemWriteStreamDelegate<T> lambda)
        {
        ...
        public static _READABLEBLOCK ReadList<T>(this _READABLEBLOCK source, ref List<T> result, ItemReadStreamDelegate<T> lambda)
        {
        ...
        public static _READABLEBLOCK ReadList<T>(this _READABLEBLOCK source, IList<T> result, ItemReadStreamDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
            if (count == 0) return source;            
        ...
        public static _READABLEBLOCK ReadList<T>(this _READABLEBLOCK source, out T[] result, ItemReadStreamDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
        ...
        public static _WRITEABLEBLOCK WriteDictionary<T>(this _WRITEABLEBLOCK target, IReadOnlyDictionary<string, T> source, ItemWriteStreamDelegate<T> lambda)
        {
            if (source == null) return target.WritePackedU64(0);
        ...
        public static _READABLEBLOCK ReadDictionary<T>(this _READABLEBLOCK source, ref Dictionary<string, T> result, ItemReadStreamDelegate<T> lambda)
        {
            result ??= new Dictionary<string,T>();
            return ReadDictionary(source, result, lambda);
        }

        public static _READABLEBLOCK ReadDictionary<T>(this _READABLEBLOCK source, IDictionary<string, T> result, ItemReadStreamDelegate<T> lambda)        
        {
            result.Clear();
