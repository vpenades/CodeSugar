...
using __READABLEBLOCK = System.ArraySegment<byte>;
using __WRITEABLEBLOCK = System.ArraySegment<byte>;
...
namespace __CODESUGAR_ROOTNAMESPACE__
{
    partial class CodeSugarSerializationExtensions
    {
        ...
        public delegate __WRITEABLEBLOCK ItemWriteArrayDelegate<T>([NotNull] __WRITEABLEBLOCK source, T item);
        public delegate __READABLEBLOCK ItemReadArrayDelegate<T>([NotNull] __READABLEBLOCK source, out T item);

        [return: NotNull]
        public static __WRITEABLEBLOCK WriteList<T>([NotNull] this __WRITEABLEBLOCK target, IReadOnlyList<T> source, ItemWriteArrayDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static __READABLEBLOCK ReadList<T>([NotNull] this __READABLEBLOCK source, ref List<T> result, ItemReadArrayDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static __READABLEBLOCK ReadList<T>([NotNull] this __READABLEBLOCK source, IList<T> result, ItemReadArrayDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
            if (count == 0) return source;            
        ...
        [return: NotNull]
        public static __READABLEBLOCK ReadList<T>([NotNull] this __READABLEBLOCK source, out T[] result, ItemReadArrayDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
        ...
        [return: NotNull]
        public static __WRITEABLEBLOCK WriteDictionary<T>([NotNull] this __WRITEABLEBLOCK target, IReadOnlyDictionary<string, T> source, ItemWriteArrayDelegate<T> lambda)
        {
            if (source == null) return target.WritePackedU64(0);
        ...
        [return: NotNull]
        public static __READABLEBLOCK ReadDictionary<T>([NotNull] this __READABLEBLOCK source, ref Dictionary<string, T> result, ItemReadArrayDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static __READABLEBLOCK ReadDictionary<T>([NotNull] this __READABLEBLOCK source, IDictionary<string, T> result, ItemReadArrayDelegate<T> lambda)        
        {
            result.Clear();
