...
using __READABLEBLOCK = System.ReadOnlySpan<byte>;
using __WRITEABLEBLOCK = System.Span<byte>;
...
namespace __CODESUGAR_ROOTNAMESPACE__
{
    partial class CodeSugarSerializationExtensions
    {
        ...
        public delegate __WRITEABLEBLOCK ItemWriteSpanDelegate<T>([NotNull] __WRITEABLEBLOCK source, T item);
        public delegate __READABLEBLOCK ItemReadSpanDelegate<T>([NotNull] __READABLEBLOCK source, out T item);

        [return: NotNull]
        public static __WRITEABLEBLOCK WriteList<T>([NotNull] this __WRITEABLEBLOCK target, IReadOnlyList<T> source, ItemWriteSpanDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static __READABLEBLOCK ReadList<T>([NotNull] this __READABLEBLOCK source, ref List<T> result, ItemReadSpanDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static __READABLEBLOCK ReadList<T>([NotNull] this __READABLEBLOCK source, IList<T> result, ItemReadSpanDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
            if (count == 0) return source;            
        ...
        [return: NotNull]
        public static __READABLEBLOCK ReadList<T>([NotNull] this __READABLEBLOCK source, out T[] result, ItemReadSpanDelegate<T> lambda)
        {
            source = source.ReadPackedU64(out var count);
        ...
        [return: NotNull]
        public static __WRITEABLEBLOCK WriteDictionary<T>([NotNull] this __WRITEABLEBLOCK target, IReadOnlyDictionary<string, T> source, ItemWriteSpanDelegate<T> lambda)
        {
            if (source == null) return target.WritePackedU64(0);
        ...
        [return: NotNull]
        public static __READABLEBLOCK ReadDictionary<T>([NotNull] this __READABLEBLOCK source, ref Dictionary<string, T> result, ItemReadSpanDelegate<T> lambda)
        {
        ...
        [return: NotNull]
        public static __READABLEBLOCK ReadDictionary<T>([NotNull] this __READABLEBLOCK source, IDictionary<string, T> result, ItemReadSpanDelegate<T> lambda)        
        {
            result.Clear();
